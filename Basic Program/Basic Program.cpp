...
int main()
{
	...
	cout << "Mass of the object: " << mass << endl;


	// adds force to an object and wont stop due to needing friction
	//box->addForce(PxVec3(100.f, 0.f, 0.f));
	...
	while (!GetAsyncKeyState(VK_ESCAPE))
	{
		...
		// Here to transform the box suddenly and effect change 
		//if (steps == 10) {
		//	box -> setGlobalPose(PxTransform(PxVec3(10.f, 0.f, 0.f)));
		//}
		if (box->isSleeping()) {
		
			cout << "shh I'm now asleep" << endl;
		...
		cout << "Number of steps completed: "<< steps << endl;
